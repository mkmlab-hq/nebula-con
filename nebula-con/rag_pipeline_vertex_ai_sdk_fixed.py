#!/usr/bin/env python3
"""
Vertex AI Python SDK를 직접 사용하는 RAG 파이프라인 (수정된 버전)
...
class RAGPipelineVertexAISDKFixed:
    """Vertex AI Python SDK를 직접 사용하는 RAG 파이프라인 (수정된 버전)"""
    ...
    def __init__(self, project_id: str = 'persona-diary-service',
        ...
        logger.info(f"🧠 임베딩 모델: textembedding-gecko@003")
        logger.info(f"🧠 생성 모델: text-bison@001")
...
3. 한국어로 답변하세요
4. 답변 끝에 "이 답변은 Vertex AI의 textembedding-gecko@003와 text-bison@001 모델을 사용하여 생성되었습니다."라고 표시하세요
...
"""
    ...
    def run_rag_pipeline(self, query: str, top_k: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                'models_used': ['textembedding-gecko@003', 'text-bison@001']
            }
    ...
    def run_full_pipeline_test(self, test_queries: List[str]) -> Dict[str, Any]:
        ...
        # 결과 저장
        output_file = 'vertex_ai_sdk_rag_results_fixed.json'
...
def main():
    ...
    # RAG 파이프라인 초기화
    rag_pipeline = RAGPipelineVertexAISDKFixed(project_id, dataset_id, location)
