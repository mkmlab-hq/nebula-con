#!/usr/bin/env python3
"""
BigQuery 환경 완벽 진단 스크립트
API 제한을 우회하여 404 오류와 ML 기능 실패의 근본 원인 파악
"""
...
def diagnose_project_access():
    ...
    try:
        ...
        # 1. 프로젝트 정보 확인
        logger.info(f"✅ 프로젝트 접근 성공: {client.project}")
        logger.info(f"   📍 위치: {client.location}")
...
if __name__ == "__main__":
    logger.info("🚀 BigQuery 환경 완벽 진단 시작")
